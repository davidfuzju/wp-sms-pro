...
class _4jawaly extends \WP_SMS\Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->has_key = \true;
        $this->gatewayFields = ['has_key' => ['id' => 'gateway_key', 'name' => 'APP Key', 'desc' => 'Enter APP key of gateway.'], 'password' => ['id' => 'gateway_password', 'name' => 'APP Secret', 'desc' => 'Enter the APP Secret.'], 'from' => ['id' => 'gateway_sender_id', 'name' => 'Source Number', 'desc' => 'Enter the source number.']];
    }
    public function SendSMS()
    {
        ...
        $args = array('headers' => array('Accept' => 'application/json', 'Content-Type' => 'application/json', 'User-Agent' => 'WP-SMS-Pro', 'Authorization' => 'Basic ' . \base64_encode($this->has_key . ':' . $this->password)), 'body' => \json_encode(array("app" => "WP-SMS-Pro", "messages" => array(array('text' => $this->msg, 'sender' => $this->from, 'numbers' => $this->to)))));
    ...
    public function GetCredit()
    {
        ...
        $args = array('headers' => array('Accept' => 'application/json', 'Content-Type' => 'application/json', 'User-Agent' => 'WP-SMS-Pr', 'Authorization' => 'Basic ' . \base64_encode($this->has_key . ':' . $this->password)));
        // Get response
