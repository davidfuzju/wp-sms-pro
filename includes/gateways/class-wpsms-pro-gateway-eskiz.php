...
class eskiz extends \WP_SMS\Gateway
{
    ...
    public function SendSMS()
    {
        ...
        try {
            ...
            foreach ($this->to as $number) {
                $arguments = ['headers' => array('Authorization' => "Bearer {$dataToken}"), 'body' => ['mobile_phone' => $number, 'message' => $this->msg, 'from' => $this->from]];
    ...
    public function GetCredit()
    {
        try {
            ...
            $token = $this->GetToken();
            $dataToken = $token->data->token;
            $arguments = ['headers' => array('Authorization' => "Bearer {$dataToken}")];
    ...
    {
        $arguments = ['body' => ['email' => $this->username, 'password' => $this->password]];
