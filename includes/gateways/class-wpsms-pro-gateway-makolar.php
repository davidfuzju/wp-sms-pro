...
class makolar extends \WP_SMS\Gateway
{
    ...
    public function SendSMS()
    {
        ...
        $response = wp_remote_get(add_query_arg(['username' => $username, 'password' => $password, 'source' => $source, 'destination' => $destination, 'message ' => $message, 'type' => '0', 'dlr' => '1'], $this->wsdl_link));
        // Check gateway credit
