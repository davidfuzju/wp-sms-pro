...
class smsbharti extends \WP_SMS\Gateway
{
    ...
    public function SendSMS()
    {
        ...
        foreach ($this->to as $to) {
            $response = wp_remote_get(add_query_arg(['key' => $this->has_key, 'senderid' => $this->from, 'contacts' => $to, 'msg' => $msg, 'campaign' => '0', 'routeid' => '13', 'type' => 'text'], \sprintf('%sapp/smsapi/index.php', $this->wsdl_link)));
        }
        // Check gateway credit
