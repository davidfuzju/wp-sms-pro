...
class AccountController extends BaseController
{
     ...
     * Create An Account
     *
     * @param array $account TODO: type description here
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     *
     * @param string $userPhone  Your phone number
     * @param string $type       Activation type
     * @param string $country    Your country
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function activationToken($userPhone, $type, $country)
    {
        //check that all required arguments are provided
        ...
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('user_phone' => $userPhone, 'type' => $type, 'country' => $country));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * Verify new account
     *
     * @param string $activationToken  TODO: type description here
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function verifyAccount($activationToken)
    {
        //check that all required arguments are provided
        ...
        //process optional query parameters
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('activation_token' => $activationToken));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * Forgot username
     *
     * @param string $email        (optional) TODO: type description here
     * @param string $phoneNumber  (optional) TODO: type description here
     * @param string $country      (optional) TODO: type description here
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function forgotUsername($email = null, $phoneNumber = null, $country = null)
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        //prepare query string for API call
        ...
        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('email' => $email, 'phone_number' => $phoneNumber, 'country' => $country));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
    ...
    public function forgotPassword($username)
    {
        ...
        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('username' => $username));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     *
     * @param integer $subaccountId     Your subaccount id.
     * @param string  $activationToken  Your email activation token.
     * @param string  $password         Your new password.
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function verifyForgotPassword($subaccountId, $activationToken, $password)
    {
        //check that all required arguments are provided
        ...
        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('subaccount_id' => $subaccountId, 'activation_token' => $activationToken, 'password' => $password));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
