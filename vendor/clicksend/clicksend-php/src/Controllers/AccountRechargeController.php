...
class AccountRechargeController extends BaseController
{
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateCreditCardInfo($number, $expiryMonth, $expiryYear, $cvc, $name)
    {
        ...
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('number' => $number, 'expiry_month' => $expiryMonth, 'expiry_year' => $expiryYear, 'cvc' => $cvc, 'name' => $name));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getPackagesList($country = null)
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        //prepare query string for API call
        ...
        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('country' => $country));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
    ...
    public function purchasePackage($packageId)
    {
        ...
        //process optional query parameters
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('package_id' => $packageId));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
    ...
    public function getTransaction($transactionId)
    {
        ...
        //process optional query parameters
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('transaction_id' => $transactionId));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
