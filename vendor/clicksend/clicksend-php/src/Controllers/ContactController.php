...
class ContactController extends BaseController
{
    ...
    public function createContact($contact, $listId)
    {
        ...
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('list_id' => $listId));
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateContact($listId, $contactId, $contact)
    {
        //check that all required arguments are provided
        ...
        //process optional query parameters
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('list_id' => $listId, 'contact_id' => $contactId));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK', 'content-type' => 'application/json; charset=utf-8');
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getContact($listId, $contactId)
    {
        //check that all required arguments are provided
     ...
     * @throws APIException Thrown if API call fails
     */
    public function removeOptedOutContacts($listId, $optOutListId)
    {
        //check that all required arguments are provided
        ...
        //process optional query parameters
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('list_id' => $listId, 'opt_out_list_id' => $optOutListId));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
