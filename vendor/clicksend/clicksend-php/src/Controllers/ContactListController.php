...
class ContactListController extends BaseController
{
     ...
     *
     * @param string $listName  Your contact list name
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createContactList($listName)
    {
        ...
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('list_name' => $listName));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * @param string  $listName  Your new list name
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateContactList($listId, $listName)
    {
        //check that all required arguments are provided
