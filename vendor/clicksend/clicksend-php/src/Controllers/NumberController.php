...
class NumberController extends BaseController
{
     ...
     * @throws APIException Thrown if API call fails
     */
    public function purchaseDedicatedNumber($dedicatedNumber)
    {
        ...
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('dedicated_number' => $dedicatedNumber));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getDedicatedNumbersByCountry($country, $search = null, $searchType = null)
    {
        //check that all required arguments are provided
        if (!isset($country)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
        ...
        //process optional query parameters
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('country' => $country));
        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('search' => $search, 'search_type' => $searchType));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
