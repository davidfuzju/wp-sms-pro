...
class PostReturnAddressController extends BaseController
{
    ...
    public function updatePostReturnAddress($returnAddressId, $addressName, $addressLine1, $addressLine2, $addressCity, $addressState, $addressPostalCode, $addressCountry)
    {
        ...
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('return_address_id' => $returnAddressId));
        //process optional query parameters
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createPostReturnAddress($address)
    {
        //check that all required arguments are provided
        if (!isset($address)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getPostReturnAddress($returnAddressId)
    {
        //check that all required arguments are provided
     ...
     * @throws APIException Thrown if API call fails
     */
    public function deletePostReturnAddress($returnAddressId)
    {
        //check that all required arguments are provided
        if (!isset($returnAddressId)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
