...
class ResellerAccountController extends BaseController
{
    ...
    public function updateResellerAccount($clientUserId, $username, $password, $userEmail, $userPhone, $userFirstName, $userLastName, $accountName, $country)
    {
        ...
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('client_user_id' => $clientUserId));
        //process optional query parameters
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createResellerAccount($account)
    {
        //check that all required arguments are provided
        if (!isset($account)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getResellerAccount($clientUserId)
    {
        //check that all required arguments are provided
