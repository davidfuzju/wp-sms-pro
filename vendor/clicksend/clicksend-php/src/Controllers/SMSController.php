...
class SMSController extends BaseController
{
     ...
     *
     * @param Models\SmsMessageCollection $messages TODO: type description here
     ...
     * @throws APIException Thrown if API call fails
     */
    public function calculatePrice($messages)
    {
        //check that all required arguments are provided
        if (!isset($messages)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getSmsHistory($dateFrom = null, $dateTo = null)
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        //prepare query string for API call
        ...
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('date_from' => $dateFrom, 'date_to' => $dateTo));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
     ...
     * @throws APIException Thrown if API call fails
     */
    public function exportHistory($filename)
    {
        //check that all required arguments are provided
        if (!isset($filename)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
        ...
        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('filename' => $filename));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createReceipt($url)
    {
        //check that all required arguments are provided
        if (!isset($url)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
     ...
     *
     * @param integer $dateBefore  (optional) TODO: type description here
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function markReceiptsAsRead($dateBefore = null)
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        //prepare query string for API call
        ...
        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('date_before' => $dateBefore));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     *
     * @param integer $messageId  TODO: type description here
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function markInboundSmsAsRead($messageId)
    {
        //check that all required arguments are provided
        if (!isset($messageId)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
        ...
        $_headers = array('user-agent' => 'ClickSendSDK');
        //prepare parameters
        $_parameters = array('message_id' => $messageId);
        //set HTTP basic auth parameters
        Request::auth(Configuration::$username, Configuration::$key);
        //call on-before Http callback
    ...
    public function cancelScheduledSms($messageId)
    {
        ...
        //process optional query parameters
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('message_id' => $messageId));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * Create sms template
     *
     * @param string $templateName  Your template name
     * @param string $body          Your template body
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSmsTemplate($templateName, $body)
    {
        //check that all required arguments are provided
        ...
        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('template_name' => $templateName, 'body' => $body));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * Delete sms template
     *
     * @param string $templateId  TODO: type description here
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function deleteSmsTemplate($templateId)
    {
        ...
        //process optional query parameters
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('template_id' => $templateId));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * Update sms template
     *
     * @param integer $templateId    TODO: type description here
     * @param string  $templateName  TODO: type description here
     * @param string  $body          TODO: type description here
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updateSmsTemplate($templateId, $templateName, $body)
    {
        //check that all required arguments are provided
     ...
     * @todo Add general description for this endpoint
     *
     * @param integer $dateBefore  (optional) An optional timestamp - mark all as read before this timestamp. If not
     *                             given, all messages will be marked as read.
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function markAllInboundSMSAsRead($dateBefore = null)
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        //prepare query string for API call
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getSpecificDeliveryReceipt($messageId)
    {
        //check that all required arguments are provided
        if (!isset($messageId)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
