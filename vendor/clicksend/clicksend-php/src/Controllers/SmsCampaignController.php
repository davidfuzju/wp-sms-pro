...
class SmsCampaignController extends BaseController
{
     ...
     */
    public function createSmsCampaign($campaign)
    {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function calculatePrice($listId, $name, $from, $body)
    {
        //check that all required arguments are provided
        ...
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('list_id' => $listId, 'name' => $name, 'from' => $from, 'body' => $body));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateSmsCampaign($smsCampaignId, $listId, $name, $from, $body, $schedule)
    {
        //check that all required arguments are provided
        ...
        //process optional query parameters
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('sms_campaign_id' => $smsCampaignId));
        //process optional query parameters
        APIHelper::appendUrlWithQueryParameters($_queryBuilder, array('list_id' => $listId, 'name' => $name, 'from' => $from, 'body' => $body, 'schedule' => $schedule));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
        $_headers = array('user-agent' => 'ClickSendSDK');
     ...
     * @throws APIException Thrown if API call fails
     */
    public function cancelSmsCampaign($smsCampaignId)
    {
        //check that all required arguments are provided
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getSmsCampaign($smsCampaignId)
    {
        //check that all required arguments are provided
        if (!isset($smsCampaignId)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
