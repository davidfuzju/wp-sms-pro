...
class SubaccountController extends BaseController
{
     ...
     * @throws APIException Thrown if API call fails
     */
    public function updateSubaccount($subaccountId, $subaccount)
    {
        ...
        $_queryBuilder = APIHelper::appendUrlWithTemplateParameters($_queryBuilder, array('subaccount_id' => $subaccountId));
        //validate and preprocess url
        $_queryUrl = APIHelper::cleanUrl($_queryBuilder);
        //prepare headers
     ...
     * @throws APIException Thrown if API call fails
     */
    public function regenerateApiKey($subaccountId)
    {
        //check that all required arguments are provided
        if (!isset($subaccountId)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
