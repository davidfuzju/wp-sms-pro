...
class VoiceController extends BaseController
{
     ...
     */
    public function sendVoice($messages)
    {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function getVoiceHistory($dateFrom = null, $dateTo = null)
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        //prepare query string for API call
     ...
     * @throws APIException Thrown if API call fails
     */
    public function cancelVoiceMessage($messageId)
    {
        //check that all required arguments are provided
        if (!isset($messageId)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
     ...
     * @throws APIException Thrown if API call fails
     */
    public function exportVoiceHistory($filename)
    {
        //check that all required arguments are provided
        if (!isset($filename)) {
            throw new \InvalidArgumentException("One or more required arguments were NULL.");
