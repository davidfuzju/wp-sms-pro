 ...
 */
namespace WPSmsPro\Vendor\Composer;

use WPSmsPro\Vendor\Composer\Autoload\ClassLoader;
use WPSmsPro\Vendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('WPSmsPro\\Vendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
