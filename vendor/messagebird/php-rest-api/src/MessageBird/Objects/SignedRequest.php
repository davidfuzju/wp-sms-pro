...
use WPSmsPro\Vendor\MessageBird\Exceptions\ValidationException;
/**
 * Class SignedRequest
 *
...
class SignedRequest extends Base
{
    ...
    public static function createFromGlobals()
    {
        ...
        $requestTimestamp = isset($_SERVER['HTTP_MESSAGEBIRD_REQUEST_TIMESTAMP']) ? (int) $_SERVER['HTTP_MESSAGEBIRD_REQUEST_TIMESTAMP'] : null;
        $signature = isset($_SERVER['HTTP_MESSAGEBIRD_SIGNATURE']) ? $_SERVER['HTTP_MESSAGEBIRD_SIGNATURE'] : null;
