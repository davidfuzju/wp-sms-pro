...
use WPSmsPro\Vendor\MessageBird\Objects\Conversation\Conversation;
...
class Conversations extends Base
{
    ...
    public function start($object, $query = null)
    {
        ...
        list(, , $body) = $this->HttpClient->performHttpRequest(HttpClient::REQUEST_POST, $this->getStartUrl(), $query, $body);
    ...
    public function create($contactId, $query = null)
    {
        ...
        list(, , $body) = $this->HttpClient->performHttpRequest(HttpClient::REQUEST_POST, $this->resourceName, $query, $body);
        return $this->processRequest($body);
    }
    /**
     * @param $object
