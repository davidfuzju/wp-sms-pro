...
use WPSmsPro\Vendor\Twilio\Rest\Autopilot\V1;
/**
...
class Autopilot extends Domain
{
    ...
    protected function getAssistants() : \WPSmsPro\Vendor\Twilio\Rest\Autopilot\V1\AssistantList
    {
     ...
     */
    protected function contextAssistants(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Autopilot\V1\AssistantContext
    {
        return $this->v1->assistants($sid);
    }
    protected function getRestoreAssistant() : \WPSmsPro\Vendor\Twilio\Rest\Autopilot\V1\RestoreAssistantList
    {
