...
use WPSmsPro\Vendor\Twilio\Rest\Bulkexports\V1;
/**
...
class Bulkexports extends Domain
{
    ...
    protected function getExports() : \WPSmsPro\Vendor\Twilio\Rest\Bulkexports\V1\ExportList
    {
     ...
     */
    protected function contextExports(string $resourceType) : \WPSmsPro\Vendor\Twilio\Rest\Bulkexports\V1\ExportContext
    {
        return $this->v1->exports($resourceType);
    }
    protected function getExportConfiguration() : \WPSmsPro\Vendor\Twilio\Rest\Bulkexports\V1\ExportConfigurationList
    {
     ...
     *                             Conferences, and Participants
     */
    protected function contextExportConfiguration(string $resourceType) : \WPSmsPro\Vendor\Twilio\Rest\Bulkexports\V1\ExportConfigurationContext
    {
