...
use WPSmsPro\Vendor\Twilio\Rest\Chat\V1;
use WPSmsPro\Vendor\Twilio\Rest\Chat\V2;
/**
...
class Chat extends Domain
{
    ...
    protected function getCredentials() : \WPSmsPro\Vendor\Twilio\Rest\Chat\V2\CredentialList
    {
     ...
     */
    protected function contextCredentials(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Chat\V2\CredentialContext
    {
        return $this->v2->credentials($sid);
    }
    protected function getServices() : \WPSmsPro\Vendor\Twilio\Rest\Chat\V2\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Chat\V2\ServiceContext
    {
