...
use WPSmsPro\Vendor\Twilio\Exceptions\ConfigurationException;
use WPSmsPro\Vendor\Twilio\Exceptions\TwilioException;
use WPSmsPro\Vendor\Twilio\Http\Client as HttpClient;
use WPSmsPro\Vendor\Twilio\Http\CurlClient;
use WPSmsPro\Vendor\Twilio\Security\RequestValidator;
use WPSmsPro\Vendor\Twilio\VersionInfo;
/**
...
class Client
{
     ...
     */
    public function request(string $method, string $uri, array $params = [], array $data = [], array $headers = [], string $username = null, string $password = null, int $timeout = null) : \WPSmsPro\Vendor\Twilio\Http\Response
    {
     ...
     */
    public function getAccount() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\AccountContext
    {
        return $this->api->v2010->account;
    }
    protected function getAddresses() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\AddressList
    {
     ...
     */
    protected function contextAddresses(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\AddressContext
    {
        return $this->api->v2010->account->addresses($sid);
    }
    protected function getApplications() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\ApplicationList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextApplications(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\ApplicationContext
    {
        return $this->api->v2010->account->applications($sid);
    }
    protected function getAuthorizedConnectApps() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppList
    {
     ...
     */
    protected function contextAuthorizedConnectApps(string $connectAppSid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppContext
    {
        return $this->api->v2010->account->authorizedConnectApps($connectAppSid);
    }
    protected function getAvailablePhoneNumbers() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountryList
    {
     ...
     */
    protected function contextAvailablePhoneNumbers(string $countryCode) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountryContext
    {
        return $this->api->v2010->account->availablePhoneNumbers($countryCode);
    }
    protected function getBalance() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\BalanceList
    {
        return $this->api->v2010->account->balance;
    }
    protected function getCalls() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\CallList
    {
     ...
     */
    protected function contextCalls(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\CallContext
    {
        return $this->api->v2010->account->calls($sid);
    }
    protected function getConferences() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\ConferenceList
    {
     ...
     */
    protected function contextConferences(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\ConferenceContext
    {
        return $this->api->v2010->account->conferences($sid);
    }
    protected function getConnectApps() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextConnectApps(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppContext
    {
        return $this->api->v2010->account->connectApps($sid);
    }
    protected function getIncomingPhoneNumbers() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumberList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextIncomingPhoneNumbers(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumberContext
    {
        return $this->api->v2010->account->incomingPhoneNumbers($sid);
    }
    protected function getKeys() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\KeyList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextKeys(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\KeyContext
    {
        return $this->api->v2010->account->keys($sid);
    }
    protected function getMessages() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\MessageList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextMessages(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\MessageContext
    {
        return $this->api->v2010->account->messages($sid);
    }
    protected function getNewKeys() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\NewKeyList
    {
        return $this->api->v2010->account->newKeys;
    }
    protected function getNewSigningKeys() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\NewSigningKeyList
    {
        return $this->api->v2010->account->newSigningKeys;
    }
    protected function getNotifications() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\NotificationList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextNotifications(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\NotificationContext
    {
        return $this->api->v2010->account->notifications($sid);
    }
    protected function getOutgoingCallerIds() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextOutgoingCallerIds(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext
    {
        return $this->api->v2010->account->outgoingCallerIds($sid);
    }
    protected function getQueues() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\QueueList
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextQueues(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\QueueContext
    {
        return $this->api->v2010->account->queues($sid);
    }
    protected function getRecordings() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\RecordingList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextRecordings(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\RecordingContext
    {
        return $this->api->v2010->account->recordings($sid);
    }
    protected function getSigningKeys() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\SigningKeyList
    {
     ...
     */
    protected function contextSigningKeys(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\SigningKeyContext
    {
        return $this->api->v2010->account->signingKeys($sid);
    }
    protected function getSip() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\SipList
    {
        return $this->api->v2010->account->sip;
    }
    protected function getShortCodes() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\ShortCodeList
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextShortCodes(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\ShortCodeContext
    {
        return $this->api->v2010->account->shortCodes($sid);
    }
    protected function getTokens() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\TokenList
    {
        return $this->api->v2010->account->tokens;
    }
    protected function getTranscriptions() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextTranscriptions(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionContext
    {
        return $this->api->v2010->account->transcriptions($sid);
    }
    protected function getUsage() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\UsageList
    {
        return $this->api->v2010->account->usage;
    }
    protected function getValidationRequests() : \WPSmsPro\Vendor\Twilio\Rest\Api\V2010\Account\ValidationRequestList
    {
