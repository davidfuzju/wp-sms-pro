...
use WPSmsPro\Vendor\Twilio\Rest\Conversations\V1;
/**
...
class Conversations extends Domain
{
    ...
    protected function getConfiguration() : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\ConfigurationList
    {
        return $this->v1->configuration;
    }
    protected function contextConfiguration() : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\ConfigurationContext
    {
        return $this->v1->configuration();
    }
    protected function getAddressConfigurations() : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\AddressConfigurationList
    {
     ...
     */
    protected function contextAddressConfigurations(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\AddressConfigurationContext
    {
        return $this->v1->addressConfigurations($sid);
    }
    protected function getConversations() : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\ConversationList
    {
     ...
     *                    resource.
     */
    protected function contextConversations(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\ConversationContext
    {
        return $this->v1->conversations($sid);
    }
    protected function getCredentials() : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\CredentialList
    {
     ...
     *                    resource.
     */
    protected function contextCredentials(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\CredentialContext
    {
        return $this->v1->credentials($sid);
    }
    protected function getParticipantConversations() : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\ParticipantConversationList
    {
        return $this->v1->participantConversations;
    }
    protected function getRoles() : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\RoleList
    {
     ...
     */
    protected function contextRoles(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\RoleContext
    {
        return $this->v1->roles($sid);
    }
    protected function getServices() : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\ServiceList
    {
     ...
     *                    resource.
     */
    protected function contextServices(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\ServiceContext
    {
        return $this->v1->services($sid);
    }
    protected function getUsers() : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\UserList
    {
     ...
     */
    protected function contextUsers(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Conversations\V1\UserContext
    {
