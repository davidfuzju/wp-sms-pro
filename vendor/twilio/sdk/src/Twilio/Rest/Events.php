...
use WPSmsPro\Vendor\Twilio\Rest\Events\V1;
/**
...
class Events extends Domain
{
    ...
    protected function getEventTypes() : \WPSmsPro\Vendor\Twilio\Rest\Events\V1\EventTypeList
    {
     ...
     */
    protected function contextEventTypes(string $type) : \WPSmsPro\Vendor\Twilio\Rest\Events\V1\EventTypeContext
    {
        return $this->v1->eventTypes($type);
    }
    protected function getSchemas() : \WPSmsPro\Vendor\Twilio\Rest\Events\V1\SchemaList
    {
     ...
     */
    protected function contextSchemas(string $id) : \WPSmsPro\Vendor\Twilio\Rest\Events\V1\SchemaContext
    {
        return $this->v1->schemas($id);
    }
    protected function getSinks() : \WPSmsPro\Vendor\Twilio\Rest\Events\V1\SinkList
    {
     ...
     */
    protected function contextSinks(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Events\V1\SinkContext
    {
        return $this->v1->sinks($sid);
    }
    protected function getSubscriptions() : \WPSmsPro\Vendor\Twilio\Rest\Events\V1\SubscriptionList
    {
     ...
     */
    protected function contextSubscriptions(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Events\V1\SubscriptionContext
    {
