...
use WPSmsPro\Vendor\Twilio\Rest\Fax\V1;
/**
...
class Fax extends Domain
{
    ...
    protected function getFaxes() : \WPSmsPro\Vendor\Twilio\Rest\Fax\V1\FaxList
    {
     ...
     */
    protected function contextFaxes(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Fax\V1\FaxContext
    {
