...
use WPSmsPro\Vendor\Twilio\Rest\FlexApi\V1;
/**
...
class FlexApi extends Domain
{
    ...
    protected function getChannel() : \WPSmsPro\Vendor\Twilio\Rest\FlexApi\V1\ChannelList
    {
     ...
     *                    fetch
     */
    protected function contextChannel(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\FlexApi\V1\ChannelContext
    {
        return $this->v1->channel($sid);
    }
    protected function getConfiguration() : \WPSmsPro\Vendor\Twilio\Rest\FlexApi\V1\ConfigurationList
    {
        return $this->v1->configuration;
    }
    protected function contextConfiguration() : \WPSmsPro\Vendor\Twilio\Rest\FlexApi\V1\ConfigurationContext
    {
        return $this->v1->configuration();
    }
    protected function getFlexFlow() : \WPSmsPro\Vendor\Twilio\Rest\FlexApi\V1\FlexFlowList
    {
     ...
     */
    protected function contextFlexFlow(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\FlexApi\V1\FlexFlowContext
    {
        return $this->v1->flexFlow($sid);
    }
    protected function getWebChannel() : \WPSmsPro\Vendor\Twilio\Rest\FlexApi\V1\WebChannelList
    {
     ...
     */
    protected function contextWebChannel(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\FlexApi\V1\WebChannelContext
    {
