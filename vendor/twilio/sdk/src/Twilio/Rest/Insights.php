...
use WPSmsPro\Vendor\Twilio\Rest\Insights\V1;
/**
...
class Insights extends Domain
{
    ...
    protected function getSettings() : \WPSmsPro\Vendor\Twilio\Rest\Insights\V1\SettingList
    {
        return $this->v1->settings;
    }
    protected function contextSettings() : \WPSmsPro\Vendor\Twilio\Rest\Insights\V1\SettingContext
    {
        return $this->v1->settings();
    }
    protected function getCalls() : \WPSmsPro\Vendor\Twilio\Rest\Insights\V1\CallList
    {
     ...
     */
    protected function contextCalls(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Insights\V1\CallContext
    {
        return $this->v1->calls($sid);
    }
    protected function getCallSummaries() : \WPSmsPro\Vendor\Twilio\Rest\Insights\V1\CallSummariesList
    {
        return $this->v1->callSummaries;
    }
    protected function getConferences() : \WPSmsPro\Vendor\Twilio\Rest\Insights\V1\ConferenceList
    {
     ...
     */
    protected function contextConferences(string $conferenceSid) : \WPSmsPro\Vendor\Twilio\Rest\Insights\V1\ConferenceContext
    {
        return $this->v1->conferences($conferenceSid);
    }
    protected function getRooms() : \WPSmsPro\Vendor\Twilio\Rest\Insights\V1\RoomList
    {
     ...
     */
    protected function contextRooms(string $roomSid) : \WPSmsPro\Vendor\Twilio\Rest\Insights\V1\RoomContext
    {
