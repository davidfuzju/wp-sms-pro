...
use WPSmsPro\Vendor\Twilio\Rest\IpMessaging\V1;
use WPSmsPro\Vendor\Twilio\Rest\IpMessaging\V2;
/**
...
class IpMessaging extends Domain
{
    ...
    protected function getCredentials() : \WPSmsPro\Vendor\Twilio\Rest\IpMessaging\V2\CredentialList
    {
     ...
     */
    protected function contextCredentials(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\IpMessaging\V2\CredentialContext
    {
        return $this->v2->credentials($sid);
    }
    protected function getServices() : \WPSmsPro\Vendor\Twilio\Rest\IpMessaging\V2\ServiceList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextServices(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\IpMessaging\V2\ServiceContext
    {
