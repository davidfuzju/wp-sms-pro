...
use WPSmsPro\Vendor\Twilio\Rest\Lookups\V1;
/**
...
class Lookups extends Domain
{
    ...
    protected function getPhoneNumbers() : \WPSmsPro\Vendor\Twilio\Rest\Lookups\V1\PhoneNumberList
    {
     ...
     */
    protected function contextPhoneNumbers(string $phoneNumber) : \WPSmsPro\Vendor\Twilio\Rest\Lookups\V1\PhoneNumberContext
    {
