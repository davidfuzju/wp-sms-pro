...
use WPSmsPro\Vendor\Twilio\Rest\Monitor\V1;
/**
...
class Monitor extends Domain
{
    ...
    protected function getAlerts() : \WPSmsPro\Vendor\Twilio\Rest\Monitor\V1\AlertList
    {
     ...
     */
    protected function contextAlerts(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Monitor\V1\AlertContext
    {
        return $this->v1->alerts($sid);
    }
    protected function getEvents() : \WPSmsPro\Vendor\Twilio\Rest\Monitor\V1\EventList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextEvents(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Monitor\V1\EventContext
    {
