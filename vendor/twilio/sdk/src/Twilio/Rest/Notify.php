...
use WPSmsPro\Vendor\Twilio\Rest\Notify\V1;
/**
...
class Notify extends Domain
{
    ...
    protected function getCredentials() : \WPSmsPro\Vendor\Twilio\Rest\Notify\V1\CredentialList
    {
     ...
     */
    protected function contextCredentials(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Notify\V1\CredentialContext
    {
        return $this->v1->credentials($sid);
    }
    protected function getServices() : \WPSmsPro\Vendor\Twilio\Rest\Notify\V1\ServiceList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextServices(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Notify\V1\ServiceContext
    {
