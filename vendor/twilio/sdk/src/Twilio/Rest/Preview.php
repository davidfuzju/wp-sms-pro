...
use WPSmsPro\Vendor\Twilio\Rest\Preview\BulkExports as PreviewBulkExports;
use WPSmsPro\Vendor\Twilio\Rest\Preview\DeployedDevices as PreviewDeployedDevices;
use WPSmsPro\Vendor\Twilio\Rest\Preview\HostedNumbers as PreviewHostedNumbers;
use WPSmsPro\Vendor\Twilio\Rest\Preview\Marketplace as PreviewMarketplace;
use WPSmsPro\Vendor\Twilio\Rest\Preview\Sync as PreviewSync;
use WPSmsPro\Vendor\Twilio\Rest\Preview\TrustedComms as PreviewTrustedComms;
use WPSmsPro\Vendor\Twilio\Rest\Preview\Understand as PreviewUnderstand;
use WPSmsPro\Vendor\Twilio\Rest\Preview\Wireless as PreviewWireless;
/**
...
class Preview extends Domain
{
    ...
    protected function getExports() : \WPSmsPro\Vendor\Twilio\Rest\Preview\BulkExports\ExportList
    {
     ...
     */
    protected function contextExports(string $resourceType) : \WPSmsPro\Vendor\Twilio\Rest\Preview\BulkExports\ExportContext
    {
        return $this->bulkExports->exports($resourceType);
    }
    protected function getExportConfiguration() : \WPSmsPro\Vendor\Twilio\Rest\Preview\BulkExports\ExportConfigurationList
    {
     ...
     *                             Conferences, and Participants
     */
    protected function contextExportConfiguration(string $resourceType) : \WPSmsPro\Vendor\Twilio\Rest\Preview\BulkExports\ExportConfigurationContext
    {
        return $this->bulkExports->exportConfiguration($resourceType);
    }
    protected function getFleets() : \WPSmsPro\Vendor\Twilio\Rest\Preview\DeployedDevices\FleetList
    {
     ...
     */
    protected function contextFleets(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\DeployedDevices\FleetContext
    {
        return $this->deployedDevices->fleets($sid);
    }
    protected function getAuthorizationDocuments() : \WPSmsPro\Vendor\Twilio\Rest\Preview\HostedNumbers\AuthorizationDocumentList
    {
     ...
     */
    protected function contextAuthorizationDocuments(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\HostedNumbers\AuthorizationDocumentContext
    {
        return $this->hostedNumbers->authorizationDocuments($sid);
    }
    protected function getHostedNumberOrders() : \WPSmsPro\Vendor\Twilio\Rest\Preview\HostedNumbers\HostedNumberOrderList
    {
     ...
     */
    protected function contextHostedNumberOrders(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\HostedNumbers\HostedNumberOrderContext
    {
        return $this->hostedNumbers->hostedNumberOrders($sid);
    }
    protected function getAvailableAddOns() : \WPSmsPro\Vendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnList
    {
     ...
     */
    protected function contextAvailableAddOns(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\Marketplace\AvailableAddOnContext
    {
        return $this->marketplace->availableAddOns($sid);
    }
    protected function getInstalledAddOns() : \WPSmsPro\Vendor\Twilio\Rest\Preview\Marketplace\InstalledAddOnList
    {
     ...
     */
    protected function contextInstalledAddOns(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\Marketplace\InstalledAddOnContext
    {
        return $this->marketplace->installedAddOns($sid);
    }
    protected function getServices() : \WPSmsPro\Vendor\Twilio\Rest\Preview\Sync\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\Sync\ServiceContext
    {
        return $this->sync->services($sid);
    }
    protected function getAssistants() : \WPSmsPro\Vendor\Twilio\Rest\Preview\Understand\AssistantList
    {
     ...
     *                    resource.
     */
    protected function contextAssistants(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\Understand\AssistantContext
    {
        return $this->understand->assistants($sid);
    }
    protected function getCommands() : \WPSmsPro\Vendor\Twilio\Rest\Preview\Wireless\CommandList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextCommands(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\Wireless\CommandContext
    {
        return $this->wireless->commands($sid);
    }
    protected function getRatePlans() : \WPSmsPro\Vendor\Twilio\Rest\Preview\Wireless\RatePlanList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextRatePlans(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\Wireless\RatePlanContext
    {
        return $this->wireless->ratePlans($sid);
    }
    protected function getSims() : \WPSmsPro\Vendor\Twilio\Rest\Preview\Wireless\SimList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextSims(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\Wireless\SimContext
    {
        return $this->wireless->sims($sid);
    }
    protected function getBrandedChannels() : \WPSmsPro\Vendor\Twilio\Rest\Preview\TrustedComms\BrandedChannelList
    {
     ...
     */
    protected function contextBrandedChannels(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Preview\TrustedComms\BrandedChannelContext
    {
        return $this->trustedComms->brandedChannels($sid);
    }
    protected function getBrandsInformation() : \WPSmsPro\Vendor\Twilio\Rest\Preview\TrustedComms\BrandsInformationList
    {
        return $this->trustedComms->brandsInformation;
    }
    protected function contextBrandsInformation() : \WPSmsPro\Vendor\Twilio\Rest\Preview\TrustedComms\BrandsInformationContext
    {
        return $this->trustedComms->brandsInformation();
    }
    protected function getCps() : \WPSmsPro\Vendor\Twilio\Rest\Preview\TrustedComms\CpsList
    {
        return $this->trustedComms->cps;
    }
    protected function contextCps() : \WPSmsPro\Vendor\Twilio\Rest\Preview\TrustedComms\CpsContext
    {
        return $this->trustedComms->cps();
    }
    protected function getCurrentCalls() : \WPSmsPro\Vendor\Twilio\Rest\Preview\TrustedComms\CurrentCallList
    {
        return $this->trustedComms->currentCalls;
    }
    protected function contextCurrentCalls() : \WPSmsPro\Vendor\Twilio\Rest\Preview\TrustedComms\CurrentCallContext
    {
        return $this->trustedComms->currentCalls();
    }
    /**
