...
use WPSmsPro\Vendor\Twilio\Rest\Pricing\V1;
use WPSmsPro\Vendor\Twilio\Rest\Pricing\V2;
/**
...
class Pricing extends Domain
{
    ...
    protected function getMessaging() : \WPSmsPro\Vendor\Twilio\Rest\Pricing\V1\MessagingList
    {
        return $this->v1->messaging;
    }
    protected function getPhoneNumbers() : \WPSmsPro\Vendor\Twilio\Rest\Pricing\V1\PhoneNumberList
    {
        return $this->v1->phoneNumbers;
    }
    protected function getVoice() : \WPSmsPro\Vendor\Twilio\Rest\Pricing\V2\VoiceList
    {
        return $this->v2->voice;
    }
    protected function getCountries() : \WPSmsPro\Vendor\Twilio\Rest\Pricing\V2\CountryList
    {
     ...
     *                           fetch
     */
    protected function contextCountries(string $isoCountry) : \WPSmsPro\Vendor\Twilio\Rest\Pricing\V2\CountryContext
    {
        return $this->v2->countries($isoCountry);
    }
    protected function getNumbers() : \WPSmsPro\Vendor\Twilio\Rest\Pricing\V2\NumberList
    {
     ...
     *                                  pricing information
     */
    protected function contextNumbers(string $destinationNumber) : \WPSmsPro\Vendor\Twilio\Rest\Pricing\V2\NumberContext
    {
