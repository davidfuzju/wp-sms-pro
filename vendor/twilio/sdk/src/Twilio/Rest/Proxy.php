...
use WPSmsPro\Vendor\Twilio\Rest\Proxy\V1;
/**
...
class Proxy extends Domain
{
    ...
    protected function getServices() : \WPSmsPro\Vendor\Twilio\Rest\Proxy\V1\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Proxy\V1\ServiceContext
    {
