...
use WPSmsPro\Vendor\Twilio\Rest\Serverless\V1;
/**
...
class Serverless extends Domain
{
    ...
    protected function getServices() : \WPSmsPro\Vendor\Twilio\Rest\Serverless\V1\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Serverless\V1\ServiceContext
    {
