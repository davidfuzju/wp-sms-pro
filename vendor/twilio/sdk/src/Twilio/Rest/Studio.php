...
use WPSmsPro\Vendor\Twilio\Rest\Studio\V1;
use WPSmsPro\Vendor\Twilio\Rest\Studio\V2;
/**
...
class Studio extends Domain
{
    ...
    protected function getFlows() : \WPSmsPro\Vendor\Twilio\Rest\Studio\V2\FlowList
    {
     ...
     */
    protected function contextFlows(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Studio\V2\FlowContext
    {
        return $this->v2->flows($sid);
    }
    protected function getFlowValidate() : \WPSmsPro\Vendor\Twilio\Rest\Studio\V2\FlowValidateList
    {
