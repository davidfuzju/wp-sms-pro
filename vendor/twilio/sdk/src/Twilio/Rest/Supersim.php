...
use WPSmsPro\Vendor\Twilio\Rest\Supersim\V1;
/**
...
class Supersim extends Domain
{
    ...
    protected function getCommands() : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\CommandList
    {
     ...
     */
    protected function contextCommands(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\CommandContext
    {
        return $this->v1->commands($sid);
    }
    protected function getEsimProfiles() : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\EsimProfileList
    {
     ...
     */
    protected function contextEsimProfiles(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\EsimProfileContext
    {
        return $this->v1->esimProfiles($sid);
    }
    protected function getFleets() : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\FleetList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextFleets(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\FleetContext
    {
        return $this->v1->fleets($sid);
    }
    protected function getIpCommands() : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\IpCommandList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextIpCommands(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\IpCommandContext
    {
        return $this->v1->ipCommands($sid);
    }
    protected function getNetworks() : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\NetworkList
    {
     ...
     */
    protected function contextNetworks(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\NetworkContext
    {
        return $this->v1->networks($sid);
    }
    protected function getNetworkAccessProfiles() : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\NetworkAccessProfileList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextNetworkAccessProfiles(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\NetworkAccessProfileContext
    {
        return $this->v1->networkAccessProfiles($sid);
    }
    protected function getSims() : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\SimList
    {
        return $this->v1->sims;
    }
    /**
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextSims(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\SimContext
    {
        return $this->v1->sims($sid);
    }
    protected function getSmsCommands() : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\SmsCommandList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextSmsCommands(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\SmsCommandContext
    {
        return $this->v1->smsCommands($sid);
    }
    protected function getUsageRecords() : \WPSmsPro\Vendor\Twilio\Rest\Supersim\V1\UsageRecordList
    {
