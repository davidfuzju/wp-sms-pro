...
class FleetContext extends InstanceContext
{
    ...
    public function update(array $options = []) : FleetInstance
    {
        ...
        $data = Values::of(['UniqueName' => $options['uniqueName'], 'NetworkAccessProfile' => $options['networkAccessProfile'], 'CommandsUrl' => $options['commandsUrl'], 'CommandsMethod' => $options['commandsMethod'], 'IpCommandsUrl' => $options['ipCommandsUrl'], 'IpCommandsMethod' => $options['ipCommandsMethod'], 'SmsCommandsUrl' => $options['smsCommandsUrl'], 'SmsCommandsMethod' => $options['smsCommandsMethod']]);
