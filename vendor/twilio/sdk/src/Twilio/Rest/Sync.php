...
use WPSmsPro\Vendor\Twilio\Rest\Sync\V1;
/**
...
class Sync extends Domain
{
    ...
    protected function getServices() : \WPSmsPro\Vendor\Twilio\Rest\Sync\V1\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Sync\V1\ServiceContext
    {
