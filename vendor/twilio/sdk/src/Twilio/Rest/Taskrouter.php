...
use WPSmsPro\Vendor\Twilio\Rest\Taskrouter\V1;
/**
...
class Taskrouter extends Domain
{
    ...
    protected function getWorkspaces() : \WPSmsPro\Vendor\Twilio\Rest\Taskrouter\V1\WorkspaceList
    {
     ...
     */
    protected function contextWorkspaces(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Taskrouter\V1\WorkspaceContext
    {
