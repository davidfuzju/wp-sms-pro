...
use WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1;
/**
...
class Trusthub extends Domain
{
    ...
    protected function getCustomerProfiles() : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\CustomerProfilesList
    {
     ...
     */
    protected function contextCustomerProfiles(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\CustomerProfilesContext
    {
        return $this->v1->customerProfiles($sid);
    }
    protected function getEndUsers() : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\EndUserList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextEndUsers(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\EndUserContext
    {
        return $this->v1->endUsers($sid);
    }
    protected function getEndUserTypes() : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\EndUserTypeList
    {
     ...
     *                    resource
     */
    protected function contextEndUserTypes(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\EndUserTypeContext
    {
        return $this->v1->endUserTypes($sid);
    }
    protected function getPolicies() : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\PoliciesList
    {
     ...
     */
    protected function contextPolicies(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\PoliciesContext
    {
        return $this->v1->policies($sid);
    }
    protected function getSupportingDocuments() : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\SupportingDocumentList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextSupportingDocuments(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\SupportingDocumentContext
    {
        return $this->v1->supportingDocuments($sid);
    }
    protected function getSupportingDocumentTypes() : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypeList
    {
     ...
     *                    Type resource
     */
    protected function contextSupportingDocumentTypes(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\SupportingDocumentTypeContext
    {
        return $this->v1->supportingDocumentTypes($sid);
    }
    protected function getTrustProducts() : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\TrustProductsList
    {
     ...
     * @param string $sid The unique string that identifies the resource.
     */
    protected function contextTrustProducts(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Trusthub\V1\TrustProductsContext
    {
