...
use WPSmsPro\Vendor\Twilio\Rest\Video\V1;
/**
...
class Video extends Domain
{
    ...
    protected function getCompositions() : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\CompositionList
    {
     ...
     */
    protected function contextCompositions(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\CompositionContext
    {
        return $this->v1->compositions($sid);
    }
    protected function getCompositionHooks() : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\CompositionHookList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextCompositionHooks(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\CompositionHookContext
    {
        return $this->v1->compositionHooks($sid);
    }
    protected function getCompositionSettings() : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\CompositionSettingsList
    {
        return $this->v1->compositionSettings;
    }
    protected function contextCompositionSettings() : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\CompositionSettingsContext
    {
        return $this->v1->compositionSettings();
    }
    protected function getRecordings() : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\RecordingList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRecordings(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\RecordingContext
    {
        return $this->v1->recordings($sid);
    }
    protected function getRecordingSettings() : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\RecordingSettingsList
    {
        return $this->v1->recordingSettings;
    }
    protected function contextRecordingSettings() : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\RecordingSettingsContext
    {
        return $this->v1->recordingSettings();
    }
    protected function getRooms() : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\RoomList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRooms(string $sid) : \WPSmsPro\Vendor\Twilio\Rest\Video\V1\RoomContext
    {
