    ...
    if (!\class_exists('Puc_v4p13_Vcs_GitLabApi', \false)) {
        class Puc_v4p13_Vcs_GitLabApi extends \Puc_v4p13_Vcs_Api
        {
            ...
            public function getLatestTag()
            {
                ...
                $tag = $versionTags[0];
                return new \Puc_v4p13_Vcs_Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $this->buildArchiveDownloadUrl($tag->name), 'apiResponse' => $tag));
            }
            /**
            ...
            public function getBranch($branchName)
            {
                ...
                $reference = new \Puc_v4p13_Vcs_Reference(array('name' => $branch->name, 'downloadUrl' => $this->buildArchiveDownloadUrl($branch->name), 'apiResponse' => $branch));
