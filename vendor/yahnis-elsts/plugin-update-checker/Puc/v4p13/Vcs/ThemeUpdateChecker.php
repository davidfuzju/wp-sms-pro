    ...
    if (!\class_exists('Puc_v4p13_Vcs_ThemeUpdateChecker', \false)) {
        class Puc_v4p13_Vcs_ThemeUpdateChecker extends \Puc_v4p13_Theme_UpdateChecker implements \Puc_v4p13_Vcs_BaseChecker
        {
            ...
            public function requestUpdate()
            {
                ...
                $update->version = \Puc_v4p13_Utils::findNotEmpty(array($remoteHeader['Version'], \Puc_v4p13_Utils::get($updateSource, 'version')));
                //The details URL defaults to the Theme URI header or the repository URL.
                $update->details_url = \Puc_v4p13_Utils::findNotEmpty(array($remoteHeader['ThemeURI'], $this->package->getHeaderValue('ThemeURI'), $this->metadataUrl));
